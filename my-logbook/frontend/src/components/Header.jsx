    ...
    <>
      <nav className="bg-white/30 backdrop-blur-xl border border-white/40 flex justify-between items-center p-6 z-50 fixed top-0 w-full">
        ...
        <div className=" middle-section">
          <Link to={'/'} className="inline-block cursor-pointer rounded-full px-3 py-1.5 text-sm font-bold uppercase tracking-wide text-slate-600 transition-all duration-200 hover:bg-blue-950 hover:text-white active:scale-95">Log In</Link>
